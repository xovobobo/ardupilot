...
void AP_InertialSensor_DRONECAN::start()
{
    ...
    uint32_t gyro_id = AP_HAL::Device::make_bus_id(AP_HAL::Device::BUS_TYPE_UAVCAN, bus_id, 2, DEVTYPE_INS_UAVCAN); // 4063491
    uint32_t accel_id = AP_HAL::Device::make_bus_id(AP_HAL::Device::BUS_TYPE_UAVCAN, bus_id, 1, DEVTYPE_INS_UAVCAN); // 4063747
    bus_id++;
